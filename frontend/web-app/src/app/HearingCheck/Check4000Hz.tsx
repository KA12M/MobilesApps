...
import soundFile from "../../sound/4000HzNew.mp4"; 


function Check4000Hz() {
  const navigate = useNavigate();

  // const soundFile = pathImageServer + "4000Hz-b29d1832.mp4";
  ...
  //         });
  //         setTimeout(() => {
  //           navigate(RoutePath.check6000Hz);
  //         }, 5000);
  //         return;
  //       } else {
  ...
  //New Version
  const soundFile = pathassets + "4000HzNew-082d8917.mp4";
  ...
  //      const keyLeft = localStorage.getItem("keyEarleft");
  //       if (keyLeft) {
  //         localStorage.setItem("scoreLeft3", "48");
  //         notification.success({
  //           message: "สำเร็จ",
  //           description: "กำลังจะพาท่านไปยังความถี่ถัดไป",
  //         });
  ...
  //         return;
  //       } else {
  //         localStorage.setItem("scoreRight3", "48");
  //         notification.success({
  //           message: "สำเร็จ",
  //           description: "กำลังจะพาท่านไปยังความถี่ถัดไป",
  //         });
  ...
  const saveDb = () => {
    ...
    if (keyLeft != null) {
      localStorage.setItem("scoreLeft3", Value);
    }
    if (keyEarRight != null) {
      localStorage.setItem("scoreRight3", Value);
    }
    navigate(RoutePath.check6000Hz);
      ...
      >
        <div className="steps-action">
          <div>
            ...
            >
              <p className="responsivecheckfont1">ระดับความดัง 4000 Hz</p>
              <GiSoundOn size={120} />
              <p
                style={{
                  fontSize: 24,
