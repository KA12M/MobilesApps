...
import soundFile from "../../sound/2000HzNew.mp4"; 
...
function Check2000Hz() {
        ...
        if (nextIndex === values.length) {
          ...
          if (prevIndex === 9) { 
            ...
            if (keyLeft) {
              ...
              localStorage.setItem("scoreRight2", "48");
              notification.success({
                message: "สำเร็จ",
                description: "กำลังจะพาท่านไปยังความถี่ถัดไป",
              });
  ...
  const saveDb = () => {
    ...
    if (keyLeft != null) {
      localStorage.setItem("scoreLeft2", Value);
    }
    if (keyEarRight != null) {
      localStorage.setItem("scoreRight2", Value);
    }
    navigate(RoutePath.check4000Hz);
      ...
      >
        <div className="steps-action">
          <div>
            ...
            >
              <p className="responsivecheckfont1">ระดับความดัง 2000 Hz</p>
              <GiSoundOn size={120} />
              <p
                style={{
                  fontSize: 24,
