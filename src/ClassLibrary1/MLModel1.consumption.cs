...
namespace ClassLibrary1
{
    public partial class MLModel1
    {
       ...
       // D:\TeeProgram\DiabeticRetinopathy\PredictYesOrNo\DRClassLibrary\ClassLibrary1\MLModel1.mlnet

        private static string MLNetModelPath = Path.GetFullPath("MLModel1.mlnet");
        //private static string MLNetModelPath = "\\ClassLibrary1\\MLModel1.mlnet";
